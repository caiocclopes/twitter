...
class TwitterConfigGenerator < Rails::Generators::Base
  ...
  def generate_scaffold
    ...
    puts source_root
    copy_file File.join(source_root, "twitter_config_model"), "/app/models/twitter_config.rb"
    copy_file File.join(source_root, "twitter_config_iPhone"), "/app/controllers/twitter_controller.rb"
  end
